                ...
                <div class="row mb-2 align-items-center">
                    <div class="col-12 text-center position-relative">
                        ...
                        @if (Auth::guard(name: 'admin')->user()->is_super)
                            <a href="{{ route('admins.add') }}" class="btn btn-primary position-absolute"
                                    ...
                                    <table class="table table-sm table-bordered border-primary "
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 30%; text-align: center; padding: 10px;">Is Super?</th>
                                                @if (Auth::guard( 'admin')->user()->is_super)
                                                    <th style="width: 20%; text-align: center; padding: 10px;">Edit</th>
                                                    <th style="width: 20%; text-align: center; padding: 10px;">Delete
                                                    </th>
                                                @endif
                                            </tr>
                                        </thead>
