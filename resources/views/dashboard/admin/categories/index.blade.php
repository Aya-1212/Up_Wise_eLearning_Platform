            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 text-center">
                        ...
                        <a href="{{ route('categories.add') }}" class="btn btn-primary position-absolute" style="top: 0; right: 0;">Add Category</a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <img src="{{ asset("uploads/categories/{$category->image}") }}" alt="=category" class="img-fluid " height="100"
                                                    width="120">
                                            </td>
                                            <td style="text-align: center;">
                                                        <a class="btn btn-success" href="{{ route('categories.edit', $category) }}">Edit</a>
                                            </td>
                                            <td style="text-align: center;">
