            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="col-8 mx-auto">
                        ...
                        action="{{ route('lessons.update', [$course->id, $content->id,$lesson->id]) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ old('title', $lesson->title) }}" name="title"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description_input" class="form-control" rows="6" cols="50"
                                    placeholder="Enter Lesson description here...">{{ old('description', $lesson->description) }}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="lesson_type" id="lesson_type_input" class="form-control">
                                    ...
                                    <option value="video"
                                        {{ old('lesson_type', $lesson->lesson_type) == 'video' ? 'selected' : '' }}>
                                        Video</option>
                                    <option value="article"
                                        {{ old('lesson_type', $lesson->lesson_type) == 'article' ? 'selected' : '' }}>
                                        Article</option>
                                </select>
                                @error('lesson_type')
                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="mb-3">
                               ...
                               <video width="250" controls>
                                    <source src="{{ asset("uploads/lessons/{$lesson->video_content}") }}" type="video/mp4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="text_content" class="form-control" rows="5">{{ old('text_content', $lesson->text_content ?? '') }}</textarea>
                                @error('text_content')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
